...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      <div className="w-full max-w-[400px] bg-surface border border-border rounded-lg p-8 glow-cyan">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-cyan font-sans font-bold text-2xl tracking-tight">
            NetCredix
          </h1>
        ...
        {/* Footer */}
        <div className="mt-6 flex items-center justify-center gap-1.5 text-muted text-xs">
